...
VLO 	.req	r0		//VLO  RN    r0
VHI 	.req	r3		//VHI  RN    r3

PCM 	.req	r0		//PCM  RN    r0
VB1		.req	r1		//VB1  RN    r1
COEF	.req	r2		//COEF RN    r2

SUM1LL	.req	r4		//SUM1LL RN  r4
SUM1LH	.req	r5		//SUM1LH RN  r5
SUM2LL	.req	r6		//SUM2LL RN  r6
SUM2LH	.req	r7		//SUM2LH RN  r7
SUM1RL	.req	r8		//SUM1RL RN  r8
SUM1RH	.req	r9		//SUM1RH RN  r9
SUM2RL	.req	r10		//SUM2RL RN  r10
SUM2RH	.req	r11		//SUM2RH RN  r11

CF1		.req	r12		//CF1    RN  r12
CF2		.req	r14		//CF2    RN  r14

SIGN	.req	r12		//SIGN   RN  r12
MAXPOS	.req	r14		//MAXPOS RN  r14
...
.macro	C64TOS	xl, xh, sign, maxPos
    mov		\xl, \xl, lsr #(20+6)		// xl = xl >> 26
    orr		\xl, \xl, \xh, lsl #(12-6)	// xl = xl | (xh << 6)
    ssat	\xl, #16, \xl
...
//  https://t.me/vadrov_channel
    push 	{r0}				//сохранение r0 в стеке
    ldr		r0, =AVI_volume		//в r0 адрес переменной AVI_volume
    ldrb	r0, [r0]			//в r0 значение по адресу r0 (т.е. значение переменной AVI_volume)
	mul 	\xl, \xl, r0		//\xl = \xl * r0
	asr		\xl, \xl, #4		//\xl = \xl >> 4 (разделить на 16)
    pop		{r0}				//восстановление r0 из стека
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
.endm
